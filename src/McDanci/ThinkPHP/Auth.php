<?php
/**
 * @copyright since 17:19 6/12/2017
...
class Auth
{
    ...
    protected $config = array(
        ...
        'auth_user' => 'auth_admin'             // 用户信息表 // TODO: original `member`
    );
...
//            }
    ...
    public function getGroups($uid)
    {
        ...
        $user_groups = Db::view($this->config['auth_group_access'], 'uid,group_id')->view($this->config['auth_group'],
            'title,rules', "{$this->config['auth_group_access']}.group_id={$this->config['auth_group']}.id")
